...
class SyncResultRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'flight_segments.*.crew.*.personnel_number' => ['nullable', 'string', 'max:32'],
            'flight_segments.*.crew.*.crew_group' => ['nullable', 'string', 'max:32'],
            'flight_segments.*.crew.*.department' => ['nullable', 'string', 'max:180'],
            'flight_segments.*.crew.*.position' => ['nullable', 'string', 'max:100'],
            'flight_segments.*.crew.*.qualification' => ['nullable', 'string', 'max:100'],
            'flight_segments.*.crew.*.seniority' => ['nullable', 'string', 'max:50'],
            'flight_segments.*.crew.*.training_notes' => ['nullable', 'string'],
            'flight_segments.*.crew.*.source_payload' => ['nullable', 'array'],
            ...
            'flight_segments.*.deferred_items.*.issued_at' => ['nullable', 'date'],
            'flight_segments.*.deferred_items.*.due_at' => ['nullable', 'date'],
            'flight_segments.*.deferred_items.*.mel' => ['nullable', 'string', 'max:100'],
            'flight_segments.*.deferred_items.*.tah' => ['nullable', 'string', 'max:50'],
            'flight_segments.*.deferred_items.*.tac' => ['nullable', 'string', 'max:50'],
