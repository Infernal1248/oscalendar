...
комментарий. Начало доступа — момент внесения; действующий срок продлевается с конца
последнего неотменённого оплаченного периода. Дата оплаты не сдвигает начало доступа назад.
Дни доступа считаются в UTC. API принимает и возвращает дату оплаты как `YYYY-MM-DD`.
