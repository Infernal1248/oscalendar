...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/subscription/orders', [\App\Http\Controllers\CheckoutController::class, 'store'])->middleware('throttle:10,1');
    Route::get('/subscription/orders', [\App\Http\Controllers\CheckoutController::class, 'pending']);
    Route::get('/subscription/orders/{order}', [\App\Http\Controllers\CheckoutController::class, 'show'])->whereUuid('order')->middleware('throttle:20,1');
